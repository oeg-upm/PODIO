...
* `demo/` contains [ibaiguillen/sparql-query-demo:v1.0](https://hub.docker.com/r/ibaiguillen/sparql-query-demo) demo docker service. Check this [demo](https://podio.linkeddata.es/demo) to run the queries or run them at the [original endpoint](https://w3id.org/podio/sparql). 
